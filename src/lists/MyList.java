...
public interface MyList<T> extends Iterable<T>{
    ...
    /*
    Iterable - что объекты этого класса можно перебирать (итерироваться).
       Он содержит один метод: Iterator<T> iterator() - возвращать итератор для коллекции.
    Iterator - собственно итератор, который позволяет обходить коллекцию.
      Содержит методы:
           boolean hasNext() - есть ли следующий элемент
           T next() - возвратить следующий элемент
           void remove() - опционально - удаляет последний возвращенный элемент
